...
namespace SharpNeat.EvolutionAlgorithms
{
        ...
        where TGenome : class, IGenome<TGenome>
    {
        ...
        public readonly NeatEvolutionAlgorithmParameters _eaParamsComplexifying;
        public readonly NeatEvolutionAlgorithmParameters _eaParamsSimplifying;

        public readonly ISpeciationStrategy<TGenome> _speciationStrategy;
        public IList<Specie<TGenome>> _specieList;
        ...
        public ComplexityRegulationMode _complexityRegulationMode;
        public readonly IComplexityRegulationStrategy _complexityRegulationStrategy;
        ...
        /// <param name="genomeFactory">The factory that was used to create the genomeList and which is therefore referenced by the genomes.</param>
        /// <param name="genomeList">An initial genome population.</param>
        public virtual void BaseInitialize(IGenomeListEvaluator<TGenome> genomeListEvaluator,
                                        IGenomeFactory<TGenome> genomeFactory,
                                        List<TGenome> genomeList)
        {
            base.Initialize(genomeListEvaluator, genomeFactory, genomeList);
        ...
        #region protected Methods [High Level Algorithm Methods. CalcSpecieStats/CreateOffspring]
        ...
        #region protected Methods [Low Level Helper Methods]
        ...
        #region protected Methods [Debugging]
